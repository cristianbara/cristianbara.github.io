...
(function (undefined) {
    ...
    root.annyang = {
        ...
        /* intermediateResult: "",
         finalResult: "",
         setIntermediateResult: function(value) {
         this.intermediateResult = value;
         },

         getIntermediateResult: function() {
         return this.intermediateResult;
         },
              
         setFinalResult: function(value) {
        ...
        init: function (commands, resetCommands) {
            ...
            recognition.onresult = function (event) {
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    intermediateResult = commandText;
                    invokeCallbacks(callbacks.resultIntermediate);
